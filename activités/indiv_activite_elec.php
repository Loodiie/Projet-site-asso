<!--Page qui s'ouvrira lorsqu'on cliquera sur une activité = page qui présentera une activité plus en détails-->
...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="indiv_activite.css">
    ...
    <body>
        ...
        <main class="vertical"> 
            <h1>Electro et Meca</h1>
            <section class="horizontal">

                    <div class="pics" id="img_duo_1">
                        <img src="../img/electro_meca1.jpeg" alt="Electro & Meca1">
                        <img src="../img/electro_meca2.jpeg" alt="Electro & Meca2">
                    </div>
                    <div class="pics" id="img_duo_2">
                        <img src="../img/electro_meca3.jpeg" alt="Electro & Meca3">
                        <img src="../img/electro_meca4.jpeg" alt="Electro & Meca4">
