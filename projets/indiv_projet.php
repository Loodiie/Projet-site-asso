<!--Page qui s'ouvrira lorsqu'on cliquera sur un projet = page qui présentera un projet plus en détails-->
...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="indiv_projet.css">
        ...
        <main class="vertical"> 
            ...
            <section class="horizontal">
                ...
                <div class="img_article" id="img_duo_1">
                    <img class="pics1" src="../img/giphy.gif" alt="projet">
                    <img class="pics1" src="../img/jiminy.jpg" alt="projet2">
                </div>
                <div class="img_article" id="img_duo_2">
                    <img class="pics1" src="../img/jiminy.jpg" alt="projet3">
                    <img class="pics1" src="../img/giphy.gif" alt="projet4">
                </div>
